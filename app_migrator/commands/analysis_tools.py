...
class AppAnalysis:
    ...
    def analyze_app_structure(self, app_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            error_msg = f"Error analyzing app structure: {e!s}"
            print(f"❌ {error_msg}")
            return self._create_error_result(error_msg)

    def _get_app_path_safe(self, app_name: str) -> Path | None:
    ...
    def analyze_hooks_file(self, app_path: Path) -> dict[str, Any]:
        ...
        try:
            ...
            with open(hooks_file, encoding='utf-8', errors='ignore') as f:
                content = f.read()
            ...
            hooks_data["error"] = f"Error analyzing hooks.py: {e!s}"
    ...
    def analyze_migration_compatibility(self, app_name: str, detailed: bool = False) -> dict[str, Any]:
        ...
        try:
            ...
            error_msg = f"Error in migration compatibility analysis: {e!s}"
            print(f"❌ {error_msg}")
    ...
    def _perform_comprehensive_compatibility_analysis(self, structure_analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            analysis["critical_issues"].append(f"Compatibility analysis error: {e!s}")
    ...
    def _identify_critical_issues(self, analysis: dict[str, Any], structure_analysis: dict[str, Any]) -> list[str]:
        ...
        try:
            ...
            issues.append(f"Error identifying critical issues: {e!s}")
    ...
    def _identify_warnings(self, analysis: dict[str, Any], structure_analysis: dict[str, Any]) -> list[str]:
        ...
        try:
            ...
            warnings.append(f"Error identifying warnings: {e!s}")
    ...
    def get_analysis_summary(self, app_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "app_name": app_name,
                "error": f"Comprehensive analysis failed: {e!s}",
