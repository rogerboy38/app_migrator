...
def git_info(app=None, api_key=None, verbose=False):
    ...
    if non_git_apps:
        click.echo("\n💡 RECOMMENDATIONS:")
        click.echo("  1. Use 'bench app-migrator git-pull --show-all' to see all apps")
        click.echo("  2. Set FRAPPE_CLOUD_API_KEY env var for more git info:")
        click.echo("     export FRAPPE_CLOUD_API_KEY='your-api-key'")
        click.echo("  3. Convert non-git apps to git repos:")
        click.echo("     bench app-migrator git-pull --convert-non-git")
        click.echo("  4. Clone missing git repos:")
        click.echo("     bench get-app app_name --branch version-15")
