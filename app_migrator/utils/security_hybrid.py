...
class APIManager:
    ...
    def _load_config(self):
        ...
        try:
            if self.config_file.exists():
                ...
                print("🔧 DEBUG: No config file, using auto")
    ...
    def _try_keyring_store(self, api_key):
        ...
        try:
            ...
            # Try to store
            print("🔧 DEBUG: Setting password in keyring...")
            keyring.set_password(self.service_name, self.username, api_key)

            # Verify it was stored
            print("🔧 DEBUG: Verifying keyring storage...")
            retrieved = keyring.get_password(self.service_name, self.username)
            if retrieved == api_key:
                print("🔧 DEBUG: Keyring storage verified successfully")
                return True
            else:
                print("🔧 DEBUG: Keyring verification failed")
                return False
    ...
    def _try_file_store(self, api_key):
        ...
        try:
            print("🔧 DEBUG: Starting encrypted file storage...")
            ...
            if self.storage_file.exists():
                try:
                    print("🔧 DEBUG: Reading existing encrypted file...")
            ...
            print("🔧 DEBUG: Encrypted file storage successful")
            return True
    ...
    def _try_simple_store(self, api_key):
        ...
        try:
            print("🔧 DEBUG: Starting simple file storage...")
            simple_file = self.storage_dir / "api_keys.json"

            data = {}
            if simple_file.exists():
                try:
                    print("🔧 DEBUG: Reading existing simple file...")
            ...
            print("🔧 DEBUG: Simple file storage successful")
            return True
    ...
    def get_api_key(self):
        ...
        if self._storage_method in ['keyring', 'auto']:
            print("🔧 DEBUG: Trying keyring retrieval...")
            ...
            if key:
                ...
                print("🔧 DEBUG: Keyring retrieval failed")

        if self._storage_method in ['file', 'auto']:
            print("🔧 DEBUG: Trying encrypted file retrieval...")
            ...
            if key:
                ...
                print("🔧 DEBUG: Encrypted file retrieval failed")

        if self._storage_method in ['simple', 'auto']:
            print("🔧 DEBUG: Trying simple file retrieval...")
            ...
            if key:
                ...
                print("🔧 DEBUG: Simple file retrieval failed")
    ...
    def _try_file_get(self):
        ...
        try:
            if not self.storage_file.exists():
                print("🔧 DEBUG: Encrypted file doesn't exist")
                return None

            print("🔧 DEBUG: Reading encrypted file...")
            with open(self.storage_file, 'rb') as f:
                encrypted_file = f.read()

            if not encrypted_file:
                print("🔧 DEBUG: Encrypted file is empty")
                return None
            ...
            if bench_id in data:
                ...
                print("🔧 DEBUG: Bench ID not found in encrypted file")
    ...
    def _try_simple_get(self):
        ...
        try:
            ...
            if not simple_file.exists():
                print("🔧 DEBUG: Simple file doesn't exist")
                return None

            print("🔧 DEBUG: Reading simple file...")
            with open(simple_file) as f:
                data = json.load(f)
            ...
            if bench_id in data:
                ...
                print("🔧 DEBUG: Bench ID not found in simple file")
    ...
    def validate_api_key(self, api_key=None):
        ...
        print("🔧 DEBUG: validate_api_key called")
        ...
        if not api_key:
            print("🔧 DEBUG: No API key to validate")
            return None
        ...
        # Pattern 2: fc_ prefix (legacy)
            ...
            print("🔧 DEBUG: Valid fc_ prefix format")
            return {
                "status": "valid",
        ...
        print("🔧 DEBUG: Key validation failed - doesn't match any pattern")
        return None
    ...
    def get_storage_info(self):
        ...
        print("🔧 DEBUG: get_storage_info called")
        info = {
    ...
    def _generate_encryption_key(self):
        ...
        print("🔧 DEBUG: Generated encryption key")
        return key
    ...
    def _generate_file_key(self):
        ...
        key = base64.urlsafe_b64encode(kdf.derive(hash_digest))
        print("🔧 DEBUG: Generated file key")
        return key
...
class SecurityManager:
    ...
    def get_user_role(api_status):
        ...
        if not api_status or api_status.get("status") != "valid":
            print("🔧 DEBUG: Returning 'guest' role")
            return "guest"

        print("🔧 DEBUG: Returning 'full' role")
        return "full"
