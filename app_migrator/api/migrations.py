...
def create_migration(source_app, target_app, migration_type="full"):
    ...
    try:
        ...
        frappe.log_error(f"Error creating migration: {e!s}")
...
def analyze_app_structure(app_name):
    ...
    try:
        ...
        frappe.log_error(f"Error analyzing app {app_name}: {e!s}")
...
def list_available_apps():
    ...
    try:
        ...
        frappe.log_error(f"Error listing apps: {e!s}")
        return []
...
def validate_migration_readiness(source_app, target_app):
    ...
    try:
        ...
        frappe.log_error(f"Error validating migration: {e!s}")
        return {
            "can_proceed": False,
